...
#include "kanga_interfaces/msg/o_drive_status.hpp"
...
using ODriveStatus = kanga_interfaces::msg::ODriveStatus;
using ControllerStatus = kanga_interfaces::msg::ControllerStatus;
using ControlMessage = kanga_interfaces::msg::ControlMessage;
